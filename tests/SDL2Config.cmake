...
if(NOT APPLE)
    ...
    set_target_properties(SDL2 PROPERTIES IMPORTED_LOCATION ${EXTERNAL_PROJECT_PREFIX}/lib/${CMAKE_SHARED_LIBRARY_PREFIX}SDL2${CMAKE_STATIC_SHARED_SUFFIX})
endif()
